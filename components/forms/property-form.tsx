...
export function PropertyForm({ property, onSuccess }: PropertyFormProps) {
  ...
  const {
    ...
    defaultValues: {
      ...
      total_commission_percent: property?.total_commission_percent || 6.0,
      seller_percent: property?.seller_percent || 50.0,
      level1_percent: property?.level1_percent || 10.0,
      level2_percent: property?.level2_percent || 5.0,
      level3_percent: property?.level3_percent || 3.0,
      level4_percent: property?.level4_percent || 2.0,
      level5_percent: property?.level5_percent || 1.0,
      level6_percent: property?.level6_percent || 1.0,
      level7_percent: property?.level7_percent || 0.5,
      level8_percent: property?.level8_percent || 0.5,
      level9_percent: property?.level9_percent || 0.5,
      level10_percent: property?.level10_percent || 0.5,
