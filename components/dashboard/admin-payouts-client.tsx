  ...
  return (
    <div className="space-y-6">
            ...
            <div className="mt-4 space-y-4">
              <div className="p-4 rounded-xl bg-muted/30 border border-border/50 space-y-1.5">
                ...
                <p className="font-bold text-foreground mt-0.5">
                  Amount: ${Number(selectedPayout?.amount).toLocaleString()}
                </p>
      ...
      <ConfirmationDialog
        ...
        description={`Are you sure you want to reject the withdrawal request of $${Number(selectedPayout?.amount).toLocaleString()} for ${selectedPayout?.profiles?.name}?`}
