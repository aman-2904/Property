  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between w-full">
        ...
        <button
          onClick={exportCSV}
          className="w-full sm:w-auto inline-flex h-9 items-center justify-center gap-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white px-3 text-xs font-semibold transition-all active:scale-[0.98] shadow-lg shadow-emerald-600/10"
        >
